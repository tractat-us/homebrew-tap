class Fgn < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/tractat-us/fgn/releases/download/v0.1.5/fgn-darwin-arm64"
  ...
  on_linux do
    on_intel do
      url "https://github.com/tractat-us/fgn/releases/download/v0.1.5/fgn-linux-x64"
